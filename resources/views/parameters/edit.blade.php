        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Role Edit</h5>
                        <span>Editing {{$role->name}} role</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::open(['route' =>['roles.update',$role->id] , 'method' => 'put','class'=>'forms-sample',]) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label text-capitalize" for="checkPermission">{{ $group->name }}</label>
                                        </div>
                                    </div>
                        ...
                        {!! Form::submit('Assign', ['class'=>'btn btn-primary mr-2']) !!}
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
