        ...
        <div class="card-body text-dark">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <!-- Patients_id Select Field -->
                    <div class="form-group  ">
                        {{Form::label('patients_id','Select Customer:') }}
                        {{Form::select('patients_id', $patients, null, ['class' => 'select2_op form-control','id' => 'patients_id', 'placeholder' => 'Pick a Customer...', 'required']) }}
