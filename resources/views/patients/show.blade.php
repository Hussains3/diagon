            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="previous-month" role="tabpanel" aria-labelledby="pills-setting-tab">
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' =>['users.update',$user->id], 'method' => 'put','class'=>'forms-sample','enctype'=>'multipart/form-data']) !!}
                            {{csrf_field()}}
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    {!! Form::label('name', 'User Name') !!}
                                    {!! Form::text('name', $user->name, ['class'=>'form-control','id'=>'exampleInputUsername1','placeholder'=>$user->name]) !!}
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 col-sm-12">
                                    ...
                                    {!! Form::text('address', $user->address, ['class'=>'form-control','id'=>'address','placeholder'=>$user->name]) !!}
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    {!! Form::label('phone', 'Phone Number') !!}
                                    {!! Form::text('phone', $user->phone, ['class'=>'form-control','id'=>'phone','placeholder'=>$user->phone]) !!}
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    {!! Form::label('dob', 'Date Of Birth') !!}
                                    {!! Form::date('dob', $user->dob, ['class'=>'form-control','id'=>'dob' ,'placeholder'=>$user->bod]) !!}
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                                    {!! Form::label('nid', 'NID Number') !!}
                                    {!! Form::text('nid', $user->nid, ['class'=>'form-control','id'=>'nid','placeholder'=>$user->nid]) !!}
                                </div>
                                <div class="form-group col-md-6 col-sm-12">
                                    {!! Form::label('balance', 'balance') !!}
                                    {!! Form::number('balance', $user->balance, ['class'=>'form-control','id'=>'balance']) !!}
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-12">
                            ...
                            <div class="row">
                                <div class="form-group ol-md-6 col-sm-12">
                                    {!! Form::label('roles', 'Roles') !!}
                                    <select name="roles" id="roles" class="col-md-12 form-control select2" multiple="multiple">
